function handleClick(){
	...
	resultsPage.insertBefore(pfactDiv(searchterm), resultsPage.childNodes[0]);
...
function lookupTerm(headline) {
	var callURL = "http://www.politifact.com/api/v/2/statement/?order_by=-ruling_date&limit=5&edition__edition_slug=truth-o-meter";
